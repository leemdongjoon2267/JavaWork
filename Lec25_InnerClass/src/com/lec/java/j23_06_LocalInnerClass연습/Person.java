...
public class Person {
	...
	public void readAge(final int age){ // PersonWithAge 와 동일한 스코프여서 안에서 바꿀 수 없음
...
//		age = 40; // 에러
		...
		class PersonWithAge{
			public void readInfo(){
				...
				System.out.println("나이: " + age); // age : readAge 메서드의 매개변수
			}
		}
...
*/
	...
	public MyReadable createInstance(final int age){
		...
		// 4
		MyReadable p = new PersonWithAge(); // 다형성
		return p;
	}
