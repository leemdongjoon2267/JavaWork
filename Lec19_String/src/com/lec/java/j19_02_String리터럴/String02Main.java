...
public class String02Main {
	...
	public static void main(String[] args) {
		...
		str2 = "He".concat("llo"); // "Hello"
		System.out.printf("str1=%s str2=%s\n", str1, str2);
		if (str1 == str2) {
			System.out.println("동일한 곳(문자열) 참조");
		} else {
			System.out.println("다른 곳(문자열) 참조");  }
		// concat 하면 새로운 문자열이 만들어지기 때문에 다른 곳 참조함

		str2 = "He" + "llo";
		// + 연산은, 연산결과가 이미 literal 존재하면 해당 literal 을 리턴
		System.out.printf("str1=%s str2=%s\n", str1, str2);
		if (str1 == str2) {
			System.out.println("동일한 곳(문자열) 참조");
		} else {
		...
		// compareTo : int 값 리턴, 동일한 문자열이면 0출력
		
		String str5 = "A";
		String str6 = "C";
		System.out.println(str5.compareTo(str6));
		// 음수값 -2, A 와 C 의 코드 값 차이
